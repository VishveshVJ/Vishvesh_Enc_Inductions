...
static const _ContactForceOptions_type_support_symbol_names_t _ContactForceOptions_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gs_ros_interfaces, msg, ContactForceOptions)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gs_ros_interfaces, msg, ContactForceOptions)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gs_ros_interfaces, msg, ContactForceOptions)() {
  return &::gs_ros_interfaces::msg::rosidl_typesupport_c::ContactForceOptions_message_type_support_handle;
}
