...
static const _SetRobotOptions_Request_type_support_symbol_names_t _SetRobotOptions_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gs_ros_interfaces, srv, SetRobotOptions_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gs_ros_interfaces, srv, SetRobotOptions_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gs_ros_interfaces, srv, SetRobotOptions_Request)() {
  return &::gs_ros_interfaces::srv::rosidl_typesupport_c::SetRobotOptions_Request_message_type_support_handle;
}
...
static const _SetRobotOptions_Response_type_support_symbol_names_t _SetRobotOptions_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gs_ros_interfaces, srv, SetRobotOptions_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gs_ros_interfaces, srv, SetRobotOptions_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gs_ros_interfaces, srv, SetRobotOptions_Response)() {
  return &::gs_ros_interfaces::srv::rosidl_typesupport_c::SetRobotOptions_Response_message_type_support_handle;
}
...
static const _SetRobotOptions_type_support_symbol_names_t _SetRobotOptions_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gs_ros_interfaces, srv, SetRobotOptions)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gs_ros_interfaces, srv, SetRobotOptions)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, gs_ros_interfaces, srv, SetRobotOptions)() {
  return &::gs_ros_interfaces::srv::rosidl_typesupport_c::SetRobotOptions_service_type_support_handle;
}
