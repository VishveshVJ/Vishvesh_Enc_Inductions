...
#include "gs_ros_interfaces/msg/detail/robot_options__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const gs_ros_interfaces::msg::JointProperty &,
  ...
  // Member: joint_properties
  {
    ...
    for (size_t i = 0; i < size; i++) {
      gs_ros_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.joint_properties[i],
        cdr);
    }
  }
  return true;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  gs_ros_interfaces::msg::RobotOptions & ros_message)
{
  // Member: joint_states_topic
  cdr >> ros_message.joint_states_topic;
  ...
  // Member: joint_properties
  {
    ...
    ros_message.joint_properties.resize(size);
    for (size_t i = 0; i < size; i++) {
      gs_ros_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.joint_properties[i]);
    }
  }
  ...
  // Member: joint_properties
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.joint_properties[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: joint_properties
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        gs_ros_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_JointProperty(
  ...
  if (is_plain) {
    ...
    using DataType = gs_ros_interfaces::msg::RobotOptions;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const gs_ros_interfaces::msg::RobotOptions *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gs_ros_interfaces::msg::RobotOptions *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RobotOptions__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const gs_ros_interfaces::msg::RobotOptions *>(
...
static size_t _RobotOptions__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RobotOptions(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RobotOptions__callbacks = {
...
static rosidl_message_type_support_t _RobotOptions__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RobotOptions__callbacks,
...
{
  return &gs_ros_interfaces::msg::typesupport_fastrtps_cpp::_RobotOptions__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gs_ros_interfaces, msg, RobotOptions)() {
  return &gs_ros_interfaces::msg::typesupport_fastrtps_cpp::_RobotOptions__handle;
}
