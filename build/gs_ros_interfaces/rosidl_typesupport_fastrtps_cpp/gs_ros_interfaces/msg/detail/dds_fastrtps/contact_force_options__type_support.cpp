...
#include "gs_ros_interfaces/msg/detail/contact_force_options__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const gs_ros_interfaces::msg::ContactForceOptions & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  gs_ros_interfaces::msg::ContactForceOptions & ros_message)
{
  // Member: options
  ...
  size_t current_alignment)
{
  ...
  // Member: min_force
  {
    ...
    size_t item_size = sizeof(ros_message.min_force[0]);
  ...
  // Member: max_force
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.max_force[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: debug_color
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gs_ros_interfaces::msg::ContactForceOptions;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const gs_ros_interfaces::msg::ContactForceOptions *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gs_ros_interfaces::msg::ContactForceOptions *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ContactForceOptions__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const gs_ros_interfaces::msg::ContactForceOptions *>(
...
static size_t _ContactForceOptions__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ContactForceOptions(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ContactForceOptions__callbacks = {
...
static rosidl_message_type_support_t _ContactForceOptions__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ContactForceOptions__callbacks,
...
{
  return &gs_ros_interfaces::msg::typesupport_fastrtps_cpp::_ContactForceOptions__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gs_ros_interfaces, msg, ContactForceOptions)() {
  return &gs_ros_interfaces::msg::typesupport_fastrtps_cpp::_ContactForceOptions__handle;
}
