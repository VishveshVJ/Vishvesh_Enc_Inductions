...
#include "gs_ros_interfaces/msg/detail/noisy_sensor_options__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const gs_ros_interfaces::msg::NoisySensorOptions & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  gs_ros_interfaces::msg::NoisySensorOptions & ros_message)
{
  // Member: resolution
  {
    cdr >> ros_message.resolution;
  ...
  size_t current_alignment)
{
  ...
  // Member: random_walk
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.random_walk[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: jitter
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gs_ros_interfaces::msg::NoisySensorOptions;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const gs_ros_interfaces::msg::NoisySensorOptions *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gs_ros_interfaces::msg::NoisySensorOptions *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _NoisySensorOptions__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const gs_ros_interfaces::msg::NoisySensorOptions *>(
...
static size_t _NoisySensorOptions__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NoisySensorOptions(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _NoisySensorOptions__callbacks = {
...
static rosidl_message_type_support_t _NoisySensorOptions__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_NoisySensorOptions__callbacks,
...
{
  return &gs_ros_interfaces::msg::typesupport_fastrtps_cpp::_NoisySensorOptions__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gs_ros_interfaces, msg, NoisySensorOptions)() {
  return &gs_ros_interfaces::msg::typesupport_fastrtps_cpp::_NoisySensorOptions__handle;
}
