...
class Metaclass_StartRecording(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'gs_ros_interfaces.srv.StartRecording')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from gs_ros_interfaces.srv import _start_recording
...
class StartRecording(metaclass=Metaclass_StartRecording):
    from gs_ros_interfaces.srv._start_recording import StartRecording_Request as Request
    from gs_ros_interfaces.srv._start_recording import StartRecording_Response as Response
