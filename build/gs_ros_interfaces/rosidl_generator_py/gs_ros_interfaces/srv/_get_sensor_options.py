...
class Metaclass_GetSensorOptions_Request(type):
    """Metaclass of message 'GetSensorOptions_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_sensor_options__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_sensor_options__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_sensor_options__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_sensor_options__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_sensor_options__request
...
class GetSensorOptions_Request(metaclass=Metaclass_GetSensorOptions_Request):
    """Message class 'GetSensorOptions_Request'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.sensor_types = kwargs.get('sensor_types', [])
    ...
    def __eq__(self, other):
        ...
        if self.names != other.names:
            return False
        if self.sensor_types != other.sensor_types:
            return False
        return True
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, str) for v in value) and
                 True), \
                "The 'sensor_types' field must be a set or sequence and each value of type 'str'"
...
class Metaclass_GetSensorOptions_Response(type):
    """Metaclass of message 'GetSensorOptions_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_sensor_options__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_sensor_options__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_sensor_options__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_sensor_options__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_sensor_options__response
...
class GetSensorOptions_Response(metaclass=Metaclass_GetSensorOptions_Response):
    """Message class 'GetSensorOptions_Response'."""
...
class Metaclass_GetSensorOptions(type):
    """Metaclass of service 'GetSensorOptions'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'gs_ros_interfaces.srv.GetSensorOptions')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__get_sensor_options

            from gs_ros_interfaces.srv import _get_sensor_options
            if _get_sensor_options.Metaclass_GetSensorOptions_Request._TYPE_SUPPORT is None:
                _get_sensor_options.Metaclass_GetSensorOptions_Request.__import_type_support__()
            if _get_sensor_options.Metaclass_GetSensorOptions_Response._TYPE_SUPPORT is None:
                _get_sensor_options.Metaclass_GetSensorOptions_Response.__import_type_support__()


class GetSensorOptions(metaclass=Metaclass_GetSensorOptions):
    from gs_ros_interfaces.srv._get_sensor_options import GetSensorOptions_Request as Request
    from gs_ros_interfaces.srv._get_sensor_options import GetSensorOptions_Response as Response
