...
bool gs_ros_interfaces__srv__set_sensor_options__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gs_ros_interfaces.srv._set_sensor_options.SetSensorOptions_Request", full_classname_dest, 66) == 0);
  }
  gs_ros_interfaces__srv__SetSensorOptions_Request * ros_message = _ros_message;
  {  // entity
...
{
  /* NOTE(esteve): Call constructor of SetSensorOptions_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gs_ros_interfaces.srv._set_sensor_options");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SetSensorOptions_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool gs_ros_interfaces__srv__set_sensor_options__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gs_ros_interfaces.srv._set_sensor_options.SetSensorOptions_Response", full_classname_dest, 67) == 0);
  }
  gs_ros_interfaces__srv__SetSensorOptions_Response * ros_message = _ros_message;
  {  // result
...
{
  /* NOTE(esteve): Call constructor of SetSensorOptions_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gs_ros_interfaces.srv._set_sensor_options");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SetSensorOptions_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
