...
bool gs_ros_interfaces__msg__contact_options__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gs_ros_interfaces.msg._contact_options.ContactOptions", full_classname_dest, 53) == 0);
  }
  gs_ros_interfaces__msg__ContactOptions * ros_message = _ros_message;
  {  // options
  ...
  {  // debug_sphere_radius
    PyObject * field = PyObject_GetAttrString(_pymsg, "debug_sphere_radius");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->debug_sphere_radius = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // debug_color
...
{
  /* NOTE(esteve): Call constructor of ContactOptions */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gs_ros_interfaces.msg._contact_options");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ContactOptions");
  ...
  {  // debug_sphere_radius
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->debug_sphere_radius);
    {
      int rc = PyObject_SetAttrString(_pymessage, "debug_sphere_radius", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
