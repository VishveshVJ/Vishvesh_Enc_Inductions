...
class Metaclass_ContactOptions(type):
    """Metaclass of message 'ContactOptions'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__contact_options
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__contact_options
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__contact_options
            cls._TYPE_SUPPORT = module.type_support_msg__msg__contact_options
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__contact_options
...
class ContactOptions(metaclass=Metaclass_ContactOptions):
    """Message class 'ContactOptions'."""

    __slots__ = [
        '_options',
        '_ros_options',
        '_rigid_options',
        '_debug_sphere_radius',
        '_debug_color',
    ]
    ...
    def __init__(self, **kwargs):
        ...
        self.debug_sphere_radius = kwargs.get('debug_sphere_radius', float())
    ...
    def __eq__(self, other):
        ...
        if self.rigid_options != other.rigid_options:
            return False
        if self.debug_sphere_radius != other.debug_sphere_radius:
            return False
    ...
    @builtins.property
    def debug_sphere_radius(self):
        """Message field 'debug_sphere_radius'."""
        return self._debug_sphere_radius

    @debug_sphere_radius.setter
    def debug_sphere_radius(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'debug_sphere_radius' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'debug_sphere_radius' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._debug_sphere_radius = value
