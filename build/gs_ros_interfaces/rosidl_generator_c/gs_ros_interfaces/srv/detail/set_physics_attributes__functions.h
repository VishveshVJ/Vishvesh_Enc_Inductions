...
#ifndef GS_ROS_INTERFACES__SRV__DETAIL__SET_PHYSICS_ATTRIBUTES__FUNCTIONS_H_
#define GS_ROS_INTERFACES__SRV__DETAIL__SET_PHYSICS_ATTRIBUTES__FUNCTIONS_H_
...
/// Initialize srv/SetPhysicsAttributes message.
/**
...
/// Finalize srv/SetPhysicsAttributes message.
/**
...
/// Create srv/SetPhysicsAttributes message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * gs_ros_interfaces__srv__SetPhysicsAttributes_Request__init().
...
/// Destroy srv/SetPhysicsAttributes message.
/**
 * It calls
 * gs_ros_interfaces__srv__SetPhysicsAttributes_Request__fini()
...
/// Check for srv/SetPhysicsAttributes message equality.
/**
...
/// Copy a srv/SetPhysicsAttributes message.
/**
...
/// Initialize array of srv/SetPhysicsAttributes messages.
/**
...
/// Finalize array of srv/SetPhysicsAttributes messages.
/**
 * It calls
 * gs_ros_interfaces__srv__SetPhysicsAttributes_Request__fini()
...
/// Create array of srv/SetPhysicsAttributes messages.
/**
 * It allocates the memory for the array and calls
 * gs_ros_interfaces__srv__SetPhysicsAttributes_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetPhysicsAttributes messages.
/**
 * It calls
 * gs_ros_interfaces__srv__SetPhysicsAttributes_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetPhysicsAttributes message array equality.
/**
...
/// Copy an array of srv/SetPhysicsAttributes messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * gs_ros_interfaces__srv__SetPhysicsAttributes_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_gs_ros_interfaces
...
/**
 * It calls
 * gs_ros_interfaces__srv__SetPhysicsAttributes_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_gs_ros_interfaces
...
/**
 * It allocates the memory for the array and calls
 * gs_ros_interfaces__srv__SetPhysicsAttributes_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_gs_ros_interfaces
...
/**
 * It calls
 * gs_ros_interfaces__srv__SetPhysicsAttributes_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // GS_ROS_INTERFACES__SRV__DETAIL__SET_PHYSICS_ATTRIBUTES__FUNCTIONS_H_
