...
static const _GeneralSensorOptions_type_support_symbol_names_t _GeneralSensorOptions_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gs_ros_interfaces, msg, GeneralSensorOptions)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gs_ros_interfaces, msg, GeneralSensorOptions)),
  }
};
...
{
  return &::gs_ros_interfaces::msg::rosidl_typesupport_cpp::GeneralSensorOptions_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gs_ros_interfaces, msg, GeneralSensorOptions)() {
  return get_message_type_support_handle<gs_ros_interfaces::msg::GeneralSensorOptions>();
}
