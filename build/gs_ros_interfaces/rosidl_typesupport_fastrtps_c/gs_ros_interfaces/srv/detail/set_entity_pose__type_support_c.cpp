...
#include "gs_ros_interfaces/srv/detail/set_entity_pose__rosidl_typesupport_fastrtps_c.h"
...
using _SetEntityPose_Request__ros_msg_type = gs_ros_interfaces__srv__SetEntityPose_Request;
...
size_t get_serialized_size_gs_ros_interfaces__srv__SetEntityPose_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetEntityPose_Request__ros_msg_type * ros_message = static_cast<const _SetEntityPose_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SetEntityPose_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gs_ros_interfaces__srv__SetEntityPose_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gs_ros_interfaces
size_t max_serialized_size_gs_ros_interfaces__srv__SetEntityPose_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gs_ros_interfaces__srv__SetEntityPose_Request;
    is_plain =
      (
...
static size_t _SetEntityPose_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gs_ros_interfaces__srv__SetEntityPose_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gs_ros_interfaces, srv, SetEntityPose_Request)() {
...
using _SetEntityPose_Response__ros_msg_type = gs_ros_interfaces__srv__SetEntityPose_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gs_ros_interfaces
size_t get_serialized_size_gs_ros_interfaces__srv__SetEntityPose_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetEntityPose_Response__ros_msg_type * ros_message = static_cast<const _SetEntityPose_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_gs_ros_interfaces__srv__SetEntityPose_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gs_ros_interfaces
size_t max_serialized_size_gs_ros_interfaces__srv__SetEntityPose_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = gs_ros_interfaces__srv__SetEntityPose_Response;
    is_plain =
      (
...
static size_t _SetEntityPose_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gs_ros_interfaces__srv__SetEntityPose_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gs_ros_interfaces, srv, SetEntityPose_Response)() {
...
// already included above
// #include "gs_ros_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "gs_ros_interfaces/srv/set_entity_pose.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gs_ros_interfaces, srv, SetEntityPose)() {
