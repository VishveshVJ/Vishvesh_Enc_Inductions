...
#include "gs_ros_interfaces/msg/detail/contact__rosidl_typesupport_fastrtps_c.h"
...
using _Contact__ros_msg_type = gs_ros_interfaces__msg__Contact;
...
size_t get_serialized_size_gs_ros_interfaces__msg__Contact(
  const void * untyped_ros_message,
...
static uint32_t _Contact__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gs_ros_interfaces__msg__Contact(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gs_ros_interfaces
size_t max_serialized_size_gs_ros_interfaces__msg__Contact(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gs_ros_interfaces__msg__Contact;
    is_plain =
      (
...
static size_t _Contact__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gs_ros_interfaces__msg__Contact(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gs_ros_interfaces, msg, Contact)() {
