...
#include "simulation_interfaces/msg/detail/tags_filter__rosidl_typesupport_fastrtps_c.h"
...
using _TagsFilter__ros_msg_type = simulation_interfaces__msg__TagsFilter;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TagsFilter__ros_msg_type * ros_message = static_cast<const _TagsFilter__ros_msg_type *>(untyped_ros_message);
  // Field name: tags
  {
  ...
  void * untyped_ros_message)
{
  ...
  _TagsFilter__ros_msg_type * ros_message = static_cast<_TagsFilter__ros_msg_type *>(untyped_ros_message);
  // Field name: tags
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
...
static uint32_t _TagsFilter__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_simulation_interfaces__msg__TagsFilter(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = simulation_interfaces__msg__TagsFilter;
    is_plain =
      (
...
static size_t _TagsFilter__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_simulation_interfaces__msg__TagsFilter(
...
static message_type_support_callbacks_t __callbacks_TagsFilter = {
...
static rosidl_message_type_support_t _TagsFilter__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TagsFilter,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, simulation_interfaces, msg, TagsFilter)() {
  return &_TagsFilter__type_support;
}
