...
#include "simulation_interfaces/srv/detail/get_entity_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = simulation_interfaces::srv::GetEntityState_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const simulation_interfaces::srv::GetEntityState_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<simulation_interfaces::srv::GetEntityState_Request *>(
    untyped_ros_message);
...
{
  return &simulation_interfaces::srv::typesupport_fastrtps_cpp::_GetEntityState_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = simulation_interfaces::srv::GetEntityState_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const simulation_interfaces::srv::GetEntityState_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<simulation_interfaces::srv::GetEntityState_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &simulation_interfaces::srv::typesupport_fastrtps_cpp::_GetEntityState_Response__handle;
}
...
{
  return &simulation_interfaces::srv::typesupport_fastrtps_cpp::_GetEntityState__handle;
}
