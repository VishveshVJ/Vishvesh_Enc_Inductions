...
#include "simulation_interfaces/msg/detail/named_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const simulation_interfaces::msg::NamedPose & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  simulation_interfaces::msg::NamedPose & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = simulation_interfaces::msg::NamedPose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const simulation_interfaces::msg::NamedPose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<simulation_interfaces::msg::NamedPose *>(
    untyped_ros_message);
...
{
  return &simulation_interfaces::msg::typesupport_fastrtps_cpp::_NamedPose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, simulation_interfaces, msg, NamedPose)() {
  return &simulation_interfaces::msg::typesupport_fastrtps_cpp::_NamedPose__handle;
}
