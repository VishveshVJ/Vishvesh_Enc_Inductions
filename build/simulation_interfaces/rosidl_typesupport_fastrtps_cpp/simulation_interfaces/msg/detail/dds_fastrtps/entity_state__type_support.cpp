...
#include "simulation_interfaces/msg/detail/entity_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = simulation_interfaces::msg::EntityState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const simulation_interfaces::msg::EntityState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<simulation_interfaces::msg::EntityState *>(
    untyped_ros_message);
...
{
  return &simulation_interfaces::msg::typesupport_fastrtps_cpp::_EntityState__handle;
}
