...
#include "simulation_interfaces/msg/detail/result__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const simulation_interfaces::msg::Result & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  simulation_interfaces::msg::Result & ros_message)
{
  // Member: result
  cdr >> ros_message.result;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = simulation_interfaces::msg::Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const simulation_interfaces::msg::Result *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<simulation_interfaces::msg::Result *>(
    untyped_ros_message);
...
{
  return &simulation_interfaces::msg::typesupport_fastrtps_cpp::_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, simulation_interfaces, msg, Result)() {
  return &simulation_interfaces::msg::typesupport_fastrtps_cpp::_Result__handle;
}
