...
#include "simulation_interfaces/msg/detail/spawnable__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const simulation_interfaces::msg::Spawnable & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  simulation_interfaces::msg::Spawnable & ros_message)
{
  // Member: entity_resource
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = simulation_interfaces::msg::Spawnable;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const simulation_interfaces::msg::Spawnable *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<simulation_interfaces::msg::Spawnable *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Spawnable__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const simulation_interfaces::msg::Spawnable *>(
...
static size_t _Spawnable__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Spawnable(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Spawnable__callbacks = {
...
static rosidl_message_type_support_t _Spawnable__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Spawnable__callbacks,
...
{
  return &simulation_interfaces::msg::typesupport_fastrtps_cpp::_Spawnable__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, simulation_interfaces, msg, Spawnable)() {
  return &simulation_interfaces::msg::typesupport_fastrtps_cpp::_Spawnable__handle;
}
