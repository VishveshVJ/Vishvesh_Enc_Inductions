...
static const _NamedPose_type_support_symbol_names_t _NamedPose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, simulation_interfaces, msg, NamedPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, simulation_interfaces, msg, NamedPose)),
  }
};
...
get_message_type_support_handle<simulation_interfaces::msg::NamedPose>()
{
  return &::simulation_interfaces::msg::rosidl_typesupport_cpp::NamedPose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, simulation_interfaces, msg, NamedPose)() {
  return get_message_type_support_handle<simulation_interfaces::msg::NamedPose>();
}
