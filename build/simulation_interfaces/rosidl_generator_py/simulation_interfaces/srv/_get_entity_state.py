    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'simulation_interfaces.srv.GetEntityState_Request')
            logger.debug(
...
class Metaclass_GetEntityState_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'simulation_interfaces.srv.GetEntityState_Response')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_GetEntityState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from simulation_interfaces.srv import _get_entity_state
...
class GetEntityState(metaclass=Metaclass_GetEntityState):
    from simulation_interfaces.srv._get_entity_state import GetEntityState_Request as Request
    from simulation_interfaces.srv._get_entity_state import GetEntityState_Response as Response
