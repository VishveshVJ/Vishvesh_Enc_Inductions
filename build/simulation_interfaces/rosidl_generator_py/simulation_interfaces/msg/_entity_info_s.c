...
bool simulation_interfaces__msg__entity_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("simulation_interfaces.msg._entity_info.EntityInfo", full_classname_dest, 49) == 0);
  }
  simulation_interfaces__msg__EntityInfo * ros_message = _ros_message;
  {  // category
    PyObject * field = PyObject_GetAttrString(_pymsg, "category");
    if (!field) {
      return false;
    }
    if (!simulation_interfaces__msg__entity_category__convert_from_py(field, &ros_message->category)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of EntityInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("simulation_interfaces.msg._entity_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EntityInfo");
  ...
  {  // category
    PyObject * field = NULL;
    field = simulation_interfaces__msg__entity_category__convert_to_py(&ros_message->category);
    if (!field) {
      return NULL;
    }
    {
