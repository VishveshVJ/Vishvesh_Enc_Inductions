...
bool simulation_interfaces__msg__bounds__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("simulation_interfaces.msg._bounds.Bounds", full_classname_dest, 40) == 0);
  }
  simulation_interfaces__msg__Bounds * ros_message = _ros_message;
  {  // type
  ...
  {  // points
    ...
    geometry_msgs__msg__Vector3 * dest = ros_message->points.data;
...
{
  /* NOTE(esteve): Call constructor of Bounds */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("simulation_interfaces.msg._bounds");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Bounds");
