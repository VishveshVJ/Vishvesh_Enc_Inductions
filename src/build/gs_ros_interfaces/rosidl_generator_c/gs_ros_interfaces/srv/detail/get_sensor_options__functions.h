...
#ifndef GS_ROS_INTERFACES__SRV__DETAIL__GET_SENSOR_OPTIONS__FUNCTIONS_H_
#define GS_ROS_INTERFACES__SRV__DETAIL__GET_SENSOR_OPTIONS__FUNCTIONS_H_
...
/// Initialize srv/GetSensorOptions message.
/**
...
/// Finalize srv/GetSensorOptions message.
/**
...
/// Create srv/GetSensorOptions message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * gs_ros_interfaces__srv__GetSensorOptions_Request__init().
...
/// Destroy srv/GetSensorOptions message.
/**
 * It calls
 * gs_ros_interfaces__srv__GetSensorOptions_Request__fini()
...
/// Check for srv/GetSensorOptions message equality.
/**
...
/// Copy a srv/GetSensorOptions message.
/**
...
/// Initialize array of srv/GetSensorOptions messages.
/**
...
/// Finalize array of srv/GetSensorOptions messages.
/**
 * It calls
 * gs_ros_interfaces__srv__GetSensorOptions_Request__fini()
...
/// Create array of srv/GetSensorOptions messages.
/**
 * It allocates the memory for the array and calls
 * gs_ros_interfaces__srv__GetSensorOptions_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetSensorOptions messages.
/**
 * It calls
 * gs_ros_interfaces__srv__GetSensorOptions_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetSensorOptions message array equality.
/**
...
/// Copy an array of srv/GetSensorOptions messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * gs_ros_interfaces__srv__GetSensorOptions_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_gs_ros_interfaces
...
/**
 * It calls
 * gs_ros_interfaces__srv__GetSensorOptions_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_gs_ros_interfaces
...
/**
 * It allocates the memory for the array and calls
 * gs_ros_interfaces__srv__GetSensorOptions_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_gs_ros_interfaces
...
/**
 * It calls
 * gs_ros_interfaces__srv__GetSensorOptions_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // GS_ROS_INTERFACES__SRV__DETAIL__GET_SENSOR_OPTIONS__FUNCTIONS_H_
