...
#include "gs_ros_interfaces/msg/detail/contact_force_options__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // debug_color, max_force, min_force
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // debug_color, max_force, min_force
...
using _ContactForceOptions__ros_msg_type = gs_ros_interfaces__msg__ContactForceOptions;

static bool _ContactForceOptions__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ContactForceOptions__ros_msg_type * ros_message = static_cast<const _ContactForceOptions__ros_msg_type *>(untyped_ros_message);
  // Field name: options
  {
  ...
  {
    size_t size = ros_message->min_force.size;
    auto array_ptr = ros_message->min_force.data;
  ...
  {
    size_t size = ros_message->max_force.size;
    auto array_ptr = ros_message->max_force.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serializeArray(array_ptr, size);
  }
  ...
  // Field name: debug_scale
  {
    cdr << ros_message->debug_scale;
  }

  return true;
}

static bool _ContactForceOptions__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _ContactForceOptions__ros_msg_type * ros_message = static_cast<_ContactForceOptions__ros_msg_type *>(untyped_ros_message);
  // Field name: options
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: min_force
  {
    ...
    if (ros_message->min_force.data) {
      rosidl_runtime_c__float__Sequence__fini(&ros_message->min_force);
    }
    if (!rosidl_runtime_c__float__Sequence__init(&ros_message->min_force, size)) {
      fprintf(stderr, "failed to create array for field 'min_force'");
      return false;
    }
    auto array_ptr = ros_message->min_force.data;
  ...
  // Field name: max_force
  {
    ...
    if (ros_message->max_force.data) {
      rosidl_runtime_c__float__Sequence__fini(&ros_message->max_force);
    }
    if (!rosidl_runtime_c__float__Sequence__init(&ros_message->max_force, size)) {
      fprintf(stderr, "failed to create array for field 'max_force'");
      return false;
    }
    auto array_ptr = ros_message->max_force.data;
    cdr.deserializeArray(array_ptr, size);
  ...
  size_t current_alignment)
{
  ...
  // field.name min_force
  {
    size_t array_size = ros_message->min_force.size;
    auto array_ptr = ros_message->min_force.data;
  ...
  // field.name max_force
  {
    size_t array_size = ros_message->max_force.size;
    auto array_ptr = ros_message->max_force.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    (void)array_ptr;
  ...
  // field.name debug_scale
  {
    size_t item_size = sizeof(ros_message->debug_scale);
...
static uint32_t _ContactForceOptions__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gs_ros_interfaces__msg__ContactForceOptions(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gs_ros_interfaces__msg__ContactForceOptions;
    is_plain =
      (
      offsetof(DataType, debug_scale) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _ContactForceOptions__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_gs_ros_interfaces__msg__ContactForceOptions(
...
static message_type_support_callbacks_t __callbacks_ContactForceOptions = {
  "gs_ros_interfaces::msg",
  "ContactForceOptions",
  _ContactForceOptions__cdr_serialize,
  _ContactForceOptions__cdr_deserialize,
  _ContactForceOptions__get_serialized_size,
  _ContactForceOptions__max_serialized_size
};

static rosidl_message_type_support_t _ContactForceOptions__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ContactForceOptions,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gs_ros_interfaces, msg, ContactForceOptions)() {
  return &_ContactForceOptions__type_support;
}
