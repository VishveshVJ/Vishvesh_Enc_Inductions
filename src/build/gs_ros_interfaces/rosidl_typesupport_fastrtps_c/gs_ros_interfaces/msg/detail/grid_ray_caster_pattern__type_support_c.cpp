...
#include "gs_ros_interfaces/msg/detail/grid_ray_caster_pattern__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // direction, size
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // direction, size

// forward declare type support functions


using _GridRayCasterPattern__ros_msg_type = gs_ros_interfaces__msg__GridRayCasterPattern;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _GridRayCasterPattern__ros_msg_type * ros_message = static_cast<const _GridRayCasterPattern__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _GridRayCasterPattern__ros_msg_type * ros_message = static_cast<_GridRayCasterPattern__ros_msg_type *>(untyped_ros_message);
  // Field name: resolution
  {
    cdr >> ros_message->resolution;
  }
  ...
  // Field name: size
  {
    ...
    if (ros_message->size.data) {
      rosidl_runtime_c__float__Sequence__fini(&ros_message->size);
    }
    if (!rosidl_runtime_c__float__Sequence__init(&ros_message->size, size)) {
  ...
  // Field name: direction
  {
    ...
    if (ros_message->direction.data) {
      rosidl_runtime_c__float__Sequence__fini(&ros_message->direction);
    }
    if (!rosidl_runtime_c__float__Sequence__init(&ros_message->direction, size)) {
...
static uint32_t _GridRayCasterPattern__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gs_ros_interfaces__msg__GridRayCasterPattern(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gs_ros_interfaces__msg__GridRayCasterPattern;
    is_plain =
      (
...
static size_t _GridRayCasterPattern__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gs_ros_interfaces__msg__GridRayCasterPattern(
...
static message_type_support_callbacks_t __callbacks_GridRayCasterPattern = {
...
static rosidl_message_type_support_t _GridRayCasterPattern__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_GridRayCasterPattern,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gs_ros_interfaces, msg, GridRayCasterPattern)() {
  return &_GridRayCasterPattern__type_support;
}
