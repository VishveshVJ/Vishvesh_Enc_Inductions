...
static const _SphericalRayCasterPattern_type_support_symbol_names_t _SphericalRayCasterPattern_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gs_ros_interfaces, msg, SphericalRayCasterPattern)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gs_ros_interfaces, msg, SphericalRayCasterPattern)),
  }
};
...
{
  return &::gs_ros_interfaces::msg::rosidl_typesupport_cpp::SphericalRayCasterPattern_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gs_ros_interfaces, msg, SphericalRayCasterPattern)() {
  return get_message_type_support_handle<gs_ros_interfaces::msg::SphericalRayCasterPattern>();
}
