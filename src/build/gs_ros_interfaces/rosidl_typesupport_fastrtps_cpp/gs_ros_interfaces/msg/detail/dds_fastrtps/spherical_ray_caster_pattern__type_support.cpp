...
#include "gs_ros_interfaces/msg/detail/spherical_ray_caster_pattern__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const gs_ros_interfaces::msg::SphericalRayCasterPattern & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  gs_ros_interfaces::msg::SphericalRayCasterPattern & ros_message)
{
  // Member: fov
  {
    cdr >> ros_message.fov;
  ...
  size_t current_alignment)
{
  ...
  // Member: fov
  {
    ...
    size_t item_size = sizeof(ros_message.fov[0]);
  ...
  // Member: n_points
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.n_points[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: angular_resolution
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.angular_resolution[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: angles
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gs_ros_interfaces::msg::SphericalRayCasterPattern;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const gs_ros_interfaces::msg::SphericalRayCasterPattern *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gs_ros_interfaces::msg::SphericalRayCasterPattern *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SphericalRayCasterPattern__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const gs_ros_interfaces::msg::SphericalRayCasterPattern *>(
...
static size_t _SphericalRayCasterPattern__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SphericalRayCasterPattern(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SphericalRayCasterPattern__callbacks = {
...
static rosidl_message_type_support_t _SphericalRayCasterPattern__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SphericalRayCasterPattern__callbacks,
...
{
  return &gs_ros_interfaces::msg::typesupport_fastrtps_cpp::_SphericalRayCasterPattern__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gs_ros_interfaces, msg, SphericalRayCasterPattern)() {
  return &gs_ros_interfaces::msg::typesupport_fastrtps_cpp::_SphericalRayCasterPattern__handle;
}
