...
static const _DepthCameraRayCasterPattern_type_support_symbol_names_t _DepthCameraRayCasterPattern_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gs_ros_interfaces, msg, DepthCameraRayCasterPattern)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gs_ros_interfaces, msg, DepthCameraRayCasterPattern)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gs_ros_interfaces, msg, DepthCameraRayCasterPattern)() {
  return &::gs_ros_interfaces::msg::rosidl_typesupport_c::DepthCameraRayCasterPattern_message_type_support_handle;
}
