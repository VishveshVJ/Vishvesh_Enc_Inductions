...
bool gs_ros_interfaces__msg__depth_camera_ray_caster_pattern__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gs_ros_interfaces.msg._depth_camera_ray_caster_pattern.DepthCameraRayCasterPattern", full_classname_dest, 82) == 0);
  }
  gs_ros_interfaces__msg__DepthCameraRayCasterPattern * ros_message = _ros_message;
  {  // res
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      float * dest = ros_message->res.data;
  ...
  {  // fov_horizontal
    PyObject * field = PyObject_GetAttrString(_pymsg, "fov_horizontal");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->fov_horizontal = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // fov_vertical
    PyObject * field = PyObject_GetAttrString(_pymsg, "fov_vertical");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->fov_vertical = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of DepthCameraRayCasterPattern */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gs_ros_interfaces.msg._depth_camera_ray_caster_pattern");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DepthCameraRayCasterPattern");
  ...
  {  // res
    ...
    if (ros_message->res.size > 0) {
      ...
      float * src = &(ros_message->res.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->res.size * sizeof(float));
      assert(data != NULL);
  ...
  {  // fov_horizontal
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->fov_horizontal);
    {
      int rc = PyObject_SetAttrString(_pymessage, "fov_horizontal", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // fov_vertical
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->fov_vertical);
    {
      int rc = PyObject_SetAttrString(_pymessage, "fov_vertical", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
