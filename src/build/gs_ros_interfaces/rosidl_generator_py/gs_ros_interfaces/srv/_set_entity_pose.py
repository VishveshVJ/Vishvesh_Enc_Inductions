...
class Metaclass_SetEntityPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'gs_ros_interfaces.srv.SetEntityPose')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from gs_ros_interfaces.srv import _set_entity_pose
...
class SetEntityPose(metaclass=Metaclass_SetEntityPose):
    from gs_ros_interfaces.srv._set_entity_pose import SetEntityPose_Request as Request
    from gs_ros_interfaces.srv._set_entity_pose import SetEntityPose_Response as Response
