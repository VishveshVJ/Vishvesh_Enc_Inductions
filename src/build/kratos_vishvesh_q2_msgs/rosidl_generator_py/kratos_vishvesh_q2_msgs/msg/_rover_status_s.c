...
bool kratos_vishvesh_q2_msgs__msg__rover_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("kratos_vishvesh_q2_msgs.msg._rover_status.RoverStatus", full_classname_dest, 53) == 0);
  }
  kratos_vishvesh_q2_msgs__msg__RoverStatus * ros_message = _ros_message;
  {  // battery_percentage
...
{
  /* NOTE(esteve): Call constructor of RoverStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("kratos_vishvesh_q2_msgs.msg._rover_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RoverStatus");
