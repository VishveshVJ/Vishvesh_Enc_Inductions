...
bool simulation_interfaces__msg__named_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("simulation_interfaces.msg._named_pose.NamedPose", full_classname_dest, 47) == 0);
  }
  simulation_interfaces__msg__NamedPose * ros_message = _ros_message;
  {  // name
...
PyObject * simulation_interfaces__msg__named_pose__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("simulation_interfaces.msg._named_pose");
