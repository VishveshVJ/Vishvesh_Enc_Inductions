...
bool simulation_interfaces__msg__result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("simulation_interfaces.msg._result.Result", full_classname_dest, 40) == 0);
  }
  simulation_interfaces__msg__Result * ros_message = _ros_message;
  {  // result
...
PyObject * simulation_interfaces__msg__result__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("simulation_interfaces.msg._result");
