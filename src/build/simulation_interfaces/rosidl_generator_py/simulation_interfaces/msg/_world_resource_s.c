...
bool simulation_interfaces__msg__world_resource__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("simulation_interfaces.msg._world_resource.WorldResource", full_classname_dest, 55) == 0);
  }
  simulation_interfaces__msg__WorldResource * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of WorldResource */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("simulation_interfaces.msg._world_resource");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WorldResource");
