...
bool simulation_interfaces__msg__tags_filter__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("simulation_interfaces.msg._tags_filter.TagsFilter", full_classname_dest, 49) == 0);
  }
  simulation_interfaces__msg__TagsFilter * ros_message = _ros_message;
  {  // tags
...
{
  /* NOTE(esteve): Call constructor of TagsFilter */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("simulation_interfaces.msg._tags_filter");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TagsFilter");
