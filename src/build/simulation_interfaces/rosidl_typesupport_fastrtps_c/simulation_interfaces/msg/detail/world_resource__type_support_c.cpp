...
#include "simulation_interfaces/msg/detail/world_resource__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // description, name, tags
#include "rosidl_runtime_c/string_functions.h"  // description, name, tags
...
using _WorldResource__ros_msg_type = simulation_interfaces__msg__WorldResource;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _WorldResource__ros_msg_type * ros_message = static_cast<const _WorldResource__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
  ...
  void * untyped_ros_message)
{
  ...
  _WorldResource__ros_msg_type * ros_message = static_cast<_WorldResource__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _WorldResource__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_simulation_interfaces__msg__WorldResource(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = simulation_interfaces__msg__WorldResource;
    is_plain =
      (
...
static size_t _WorldResource__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_simulation_interfaces__msg__WorldResource(
...
static message_type_support_callbacks_t __callbacks_WorldResource = {
...
static rosidl_message_type_support_t _WorldResource__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_WorldResource,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, simulation_interfaces, msg, WorldResource)() {
  return &_WorldResource__type_support;
}
