...
#include "simulation_interfaces/msg/detail/entity_info__rosidl_typesupport_fastrtps_c.h"
...
#include "simulation_interfaces/msg/detail/entity_category__functions.h"  // category
...
using _EntityInfo__ros_msg_type = simulation_interfaces__msg__EntityInfo;

static bool _EntityInfo__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _EntityInfo__ros_msg_type * ros_message = static_cast<const _EntityInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: category
  {
...
static bool _EntityInfo__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _EntityInfo__ros_msg_type * ros_message = static_cast<_EntityInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: category
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_simulation_interfaces__msg__EntityCategory(
    &(ros_message->category), current_alignment);
  // field.name description
...
static uint32_t _EntityInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_simulation_interfaces__msg__EntityInfo(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = simulation_interfaces__msg__EntityInfo;
    is_plain =
      (
...
static size_t _EntityInfo__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_simulation_interfaces__msg__EntityInfo(
...
static message_type_support_callbacks_t __callbacks_EntityInfo = {
  "simulation_interfaces::msg",
  "EntityInfo",
  _EntityInfo__cdr_serialize,
  _EntityInfo__cdr_deserialize,
  _EntityInfo__get_serialized_size,
  _EntityInfo__max_serialized_size
};

static rosidl_message_type_support_t _EntityInfo__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_EntityInfo,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, simulation_interfaces, msg, EntityInfo)() {
  return &_EntityInfo__type_support;
}
