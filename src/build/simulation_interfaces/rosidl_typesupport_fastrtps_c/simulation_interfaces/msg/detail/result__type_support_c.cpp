...
#include "simulation_interfaces/msg/detail/result__rosidl_typesupport_fastrtps_c.h"
...
using _Result__ros_msg_type = simulation_interfaces__msg__Result;
...
static uint32_t _Result__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_simulation_interfaces__msg__Result(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = simulation_interfaces__msg__Result;
    is_plain =
      (
...
static size_t _Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_simulation_interfaces__msg__Result(
