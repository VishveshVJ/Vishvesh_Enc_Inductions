...
static const _WorldResource_type_support_symbol_names_t _WorldResource_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, simulation_interfaces, msg, WorldResource)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, simulation_interfaces, msg, WorldResource)),
  }
};
...
{
  return &::simulation_interfaces::msg::rosidl_typesupport_cpp::WorldResource_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, simulation_interfaces, msg, WorldResource)() {
  return get_message_type_support_handle<simulation_interfaces::msg::WorldResource>();
}
